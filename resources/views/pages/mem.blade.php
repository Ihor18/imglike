        ...
        <div class="collapse">
            <div class="card active">
                <div class="card-header no-after">
                    <p>{{__('localization.generator_parameters')}}</p>
                </div>
                <div class="card-body pos-rel">
                    <div class="tabs mb-65">
                        <div class="tab-radiobox flex nowrap">
                            <div class="item active" data-tab="tab-inner">{{__('localization.text')}} {{__('localization.inside')}}</div>
                            <div class="item" data-tab="tab-outer">{{__('localization.text')}} {{__('localization.outside')}}
                            </div>
                        </div>
                        <div class="tab-content current tab-inner">
                            <button class="btn-grey add-img"><p>{{__('localization.add')}} {{__('localization.image')}}</p>
                            </button>
                            <button onclick="createInput()" class="btn-grey add-text">
                                <p>{{__('localization.add')}} {{__('localization.stext')}}</p></button>
                        </div>
                        <div class="tab-content tab-outer">
                            <button class="btn-grey add-img"><p>{{__('localization.add')}} {{__('localization.image')}}</p>
                            </button>
                            <button class="btn-grey add-text"><p>{{__('localization.add')}} {{__('localization.stext')}}</p>
                            </button>
                        </div>
                    </div>
