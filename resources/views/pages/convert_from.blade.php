...
@section('content')
    ...
    <div class="sidebar" style="display: none">
        <div class="collapse">
            <div class="card active pos-rel" style="height: 423px">
                ...
                <div class="tabs card-body">
                    <div class="tabs tab-radiobox flex nowrap">
                        <div class="item active" onclick="changeTab(this)" data-tab="tab-png">{{__('localization.in')}} PNG</div>
                        <div class="item" onclick="changeTab(this)" data-tab="tab-gif">{{__('localization.in')}} GIF</div>
                    </div>
                    <div class="tab-content current tab-png">
                        <div class="hint">{{__('localization.all_images_will_convert')}} PNG</div>
                    </div>
